...
checkpointer = ModelCheckpoint(filepath='saved_models/r-cnn-test4-TEST-history.weights.best.data-200.hdf5',
...
"""
model.load_weights('saved_models/r-cnn-test4-TEST-history.weights.best.data-200.hdf5')
...
plt.savefig('saved_models/r-cnn-test4-TEST-history.accuracy.svg')
plt.clf()
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('saved_models/r-cnn-test4-TEST-history.loss.svg')
plt.show()
